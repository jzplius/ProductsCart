...
import com.products.cart.data.local.db.AppDatabase
import com.products.cart.data.remote.network.MockyApiClient
import com.products.cart.data.remote.network.MockyApiService
import com.products.cart.utils.AppConstants
import com.products.cart.utils.NetworkUtils
...
val appModule = module {
    single { get<Retrofit>().create(MockyApiService::class.java) }
...
private fun provideRetrofit(okHttpClient: OkHttpClient) = Retrofit.Builder()
    .baseUrl(MockyApiClient.BASE_URL)
    .client(okHttpClient)
